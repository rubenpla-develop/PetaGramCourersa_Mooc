...
public class ParamKeys {
    ...
    public static final String KEY_EXTRA_MEDIA_ID = "MEDIA_ID";
    public static final String KEY_FIREBASE_PARAM = "KEY_FIREBASE_PARAM";
    public static final String KEY_EXTRA_PROFILE_INFO = "KEY_EXTRA_PROFILE_INFO";
}
